  ...
  return (
    <AnimatedPage>
      <div className="min-h-screen flex">
        ...
        {/* Right Panel - Visual */}
        <div className="hidden lg:flex flex-1 bg-gradient-to-br from-emerald-500/10 via-cyan-500/10 to-violet-500/10 border-l border-border items-center justify-center p-12 relative overflow-hidden">
          <div className="absolute inset-0 bg-grid opacity-30" />
          <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-emerald-500/20 rounded-full blur-3xl" />
          ...
          <div className="relative text-center max-w-md">
            ...
            >
              <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-500 to-cyan-500 flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-emerald-500/30">
                <Leaf className="w-10 h-10 text-white" />
              </div>
              <h2 className="text-2xl font-bold text-foreground mb-4">Reduce food waste by up to 80%</h2>
              <p className="text-muted-foreground">Join 12,000+ kitchens already making a difference with AI-powered waste management.</p>
            </motion.div>
          </div>
        </div>
      </div>
